...
% This script tests 'fcn_AVAR_favar' on random walk+white noise
%
...
noise_signal = noise_signal(number_of_time_steps-2^p:number_of_time_steps);
...
fcn_AVAR_favar(noise_signal,list_of_correlation_intervals,12345);
